...
function Button1(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "button1", onClick: props.onClick, children: props.text });
}
function OutputBox(props) {
  const [copyCount, setCopyCount] = reactExports.useState(0);
  function h_copyClick() {
    copy$1(props.text);
    setCopyCount(copyCount + 1);
  }
  function r_copyCount() {
    if (!copyCount) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "copied-indicator", children: [
      "copied ",
      copiedCountText
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "output-box", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "output-string", children: props.text }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button1, { text: "Copy", onClick: h_copyClick }),
    r_copyCount()
  ] });
}
function processExpandedPrompt(expandedPrompt) {
  const lines = expandedPrompt.split("\n");
  ...
  collectedPrompts.push(currentPrompt);
  collectedPrompts = _.map(collectedPrompts, (prompt) => {
    return _.uniq(prompt);
  });
  return _.map(collectedPrompts, (prompt) => {
    return prompt.join(", ");
  });
}
function processLine(line) {
  ...
  const cleanedParts = _(line.split(",")).map((linePart) => {
...
function PromptCombinerIndex() {
  const [mainPromptContent, setMainPromptContent] = reactExports.useState(void 0);
  const splitPrompts = reactExports.useMemo(() => {
  ...
  reactExports.useEffect(() => {
    const savedPrompt = getLastPrompt();
    if (savedPrompt) {
      setMainPromptContent(savedPrompt);
    }
  }, []);
  const setLastPrompt_delayed = _.debounce(setLastPrompt, 500);
  function h_mainPromptChange(e) {
    setMainPromptContent(e.currentTarget.value);
    setLastPrompt_delayed(e.currentTarget.value);
  }
  function r_outputBoxes() {
    if (!splitPrompts.length) {
      return [/* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "no outputs" })];
    }
    return _.map(splitPrompts, (prompt, i) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(OutputBox, { text: prompt }, i);
    });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-zone", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "info-box", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Enter an expanded prompt in the below input." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inner-input-zone", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Prompt Input" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { className: "input-textarea", onChange: h_mainPromptChange, value: mainPromptContent })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "output-zone", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Combined Prompt Output" }),
      r_outputBoxes()
    ] })
  ] });
}
function main() {
  createRoot(document.querySelector("main")).render(/* @__PURE__ */ jsxRuntimeExports.jsx(PromptCombinerIndex, {}));
}
window.onload = main;
//# sourceMappingURL=index-BPSfGzfs.js.map
